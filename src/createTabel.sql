...
-- Code has been reviewed and checked againse TPC-DI_SPEC_v1.1.0.pdf
...
-- reviewed
CREATE TABLE DimCompany (   SK_CompanyID INTEGER NOT NULL IDENTITY (1,1) PRIMARY KEY, 
...
-- TODO #1 integer vs char(5) vs varchar(5)
-- reviewed
...
-- TODO #2 Will need to transform all DATE values into appropriate format for SQL Server. No transformation occurs at load
-- reviewd
